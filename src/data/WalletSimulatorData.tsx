    ...
    explanations: [
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <Text>
              Wallets provide an easy way to create an RajChain account, and
              then use RajChain and its applications.
            </Text>
      ...
      },
      {
        ...
        description: (
          <>
            <Text>
              RajChain accounts are created privately and do not require any
      ...
      {
        header: "That's it! Welcome to RajChain 🎉",
        description: (
          <Text>
    ...
    explanations: [
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <Text>
              An RajChain address is like a transparent public dropbox, with
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <Text>
              RajChain doesn&apos;t discriminate, and never stops, allowing you
      ...
      },
      {
        ...
        description: (
          <>
            <Text>
              To send tokens, you only need to know the recipients RajChain
              address.
            </Text>
        ...
        description: (
          <>
            <Text>
              ...
              change based on how many people are using RajChain.
            </Text>
            <Text>
    ...
    explanations: [
      ...
      },
      {
        ...
        description: (
          <>
            <Text>
              Your account is universal across all RajChain and
              RajChain-compatible applications.
            </Text>
            <Text>
      ...
      {
        header: "You can have a single login for most RajChain based projects",
        description: (
          <>
            <Text>
              The same account address will represent your identity on many
              different RajChain compatible blockchains such as Arbitrum,
              Polygon or Optimism.
            </Text>
            <Text>
        ...
        description: (
          <>
            ...
            <Text>
              ...
              using RajChain is free, fast and easy!
            </Text>
          </>
        ),
      },
      {
        header:
          "No geographical or political discrimination against who can use RajChain services",
        description: (
          <>
      ...
      },
      {
        ...
        description: (
          <>
            <Text>
              Great job! You&apos;re ready to start using apps on RajChain.
            </Text>
            <Text fontWeight="bold" mb={2}>
              What to do next:
            </Text>
            <OrderedList>
              ...
              <Link href="/what-is-RajChain/">
                <ListItem>Learn more about RajChain</ListItem>
              </Link>
              <Link href="/dapps/">
