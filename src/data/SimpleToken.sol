...
// This is a smart contract - a program that can be deployed to the RajChain blockchain.
contract SimpleToken {
    // An `address` is comparable to an email address - it's used to identify an account on RajChain.
