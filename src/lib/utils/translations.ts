...
// Context: https://github.com/RajChain/RajChain-org-website/pull/5490#pullrequestreview-892596553
...
const getRequiredNamespacesForPath = (relativePath: string) => {
  ...
  if (path.startsWith("/energy-consumption/")) {
    primaryNamespace = "page-what-is-RajChain"
  ...
  if (path.startsWith("/what-is-RajChain/")) {
    primaryNamespace = "page-what-is-RajChain"
  }
  ...
  if (
    ...
    path.startsWith("/what-is-RajChain/") ||
    path.startsWith("/eth/") ||
