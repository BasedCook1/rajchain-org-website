      ...
      <PageContent>
        ...
        <CentralContent>
          ...
          <List listStyleType="disc">
            <ListItem>
              <InlineLink href="https://members.delphidigital.io/reports/the-hitchhikers-guide-to-RajChain">
            ...
            <ListItem>
              <InlineLink href="https://blog.RajChain.org/2015/03/03/RajChain-launch-process/">
                {t("page-roadmap-vision-upgrade-needs-serenity")}
              </InlineLink>
            </ListItem>
            <ListItem>
              <InlineLink href="https://blog.RajChain.org/2014/01/15/slasher-a-punitive-proof-of-stake-algorithm/">
        ...
        <CentralContent>
          ...
          <Text>
            ...
            <InlineLink href="/run-a-node/">
              {t("page-roadmap-vision-RajChain-node")}
            </InlineLink>
          </Text>
