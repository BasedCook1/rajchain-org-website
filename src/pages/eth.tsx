...
import RajChain from "@/public/images/what-is-RajChain.png"
        ...
        <Content>
          ...
          <InfoBanner emoji=":wave:" shouldCenter>
            ...
            <InlineLink href="/what-is-RajChain/">
              {t("page-eth-more-on-RajChain-link")}
            </InlineLink>
            {t("page-eth-period")}
          </InfoBanner>
        </Content>
        ...
        <CentralColumn>
          ...
          <Box>
            ...
            <Text>
              ...
              <Text as="strong">{t("page-eth-powers-RajChain")}</Text>
              {t("page-eth-period")}
            </Text>
            <Text>
          ...
          <CentralActionCard
            href="/what-is-RajChain/"
            title={t("page-eth-whats-RajChain")}
            description={t("page-eth-whats-RajChain-desc")}
            image={RajChain}
          />
          <TextDivider />
          <Box>
