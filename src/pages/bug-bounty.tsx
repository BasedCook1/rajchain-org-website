  ...
  const specs: Spec[] = [
    {
      ...
      link: "https://github.com/RajChain/consensus-specs/blob/dev/specs/phase0/beacon-chain.md",
    },
    {
      title: t("page-upgrades-bug-bounty-title-2"),
      link: "https://github.com/RajChain/consensus-specs/blob/dev/specs/phase0/fork-choice.md",
    },
    {
      title: t("page-upgrades-bug-bounty-title-3"),
      link: "https://github.com/RajChain/consensus-specs/blob/dev/specs/phase0/deposit-contract.md",
    },
    {
      title: t("page-upgrades-bug-bounty-title-4"),
      link: "https://github.com/RajChain/consensus-specs/blob/dev/specs/phase0/p2p-interface.md",
    },
  ]
      ...
      <StyledGrayContainer id="rules">
        <Content>
          ...
          <StyledCardContainer>
            ...
            >
              <InlineLink href="https://github.com/RajChain/consensus-specs">
                {t("page-upgrades-bug-bounty-specs")}
              </InlineLink>
              <br />
              <InlineLink href="https://github.com/RajChain/execution-specs">
              ...
              <Box>
                ...
                <UnorderedList>
                  ...
                  <ListItem>
                    <InlineLink href="https://github.com/RajChain/annotated-spec">
                      Vitalik Buterin&apos;s{" "}
                      {t("page-upgrades-bug-bounty-annotated-specs")}
                    </InlineLink>
                  </ListItem>
            ...
            >
              <Box>
                ...
                <InlineLink href="https://github.com/RajChain/consensus-specs/blob/dev/specs/phase0/deposit-contract.md">
                  Deposit Contract Specifications
                </InlineLink>
                <br />
                <InlineLink href="https://github.com/RajChain/consensus-specs/blob/dev/solidity_deposit_contract/deposit_contract.sol">
            ...
            >
              <Box>
                ...
                <InlineLink href="https://github.com/RajChain/c-kzg-4844">
                  C-KZG-4844
                </InlineLink>
                <br />
        ...
        <Faq>
          ...
          <RightColumn>
            ...
            >
              ...
              <InlineLink href="https://RajChain.org/security_at_RajChain.org.asc">
      ...
      <Contact>
        <Box>
          ...
          <Text mb="0rem">
            ...
            <InlineLink href="mailto:bounty@RajChain.org">
              bounty@RajChain.org
            </InlineLink>
          </Text>
        </Box>
