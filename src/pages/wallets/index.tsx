...
const WalletsPage = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: t("page-wallets-your-RajChain-account"),
      description: (
        <Translation id="page-wallets:page-wallets-your-RajChain-account-desc" />
      ),
    },
    {
  ...
  const guides = [
    {
      title: t("additional-reading-how-to-create-an-RajChain-account"),
      link: "/guides/how-to-create-an-RajChain-account/",
      customEventOptions: {
        eventCategory: "Link",
        eventAction: "Clicked",
      ...
      <TwoColumnContent marginBottom={-8} marginTop={8}>
        <LeftColumn>
          ...
          <ul>
            <li>
              <Text>
                <Translation id="page-wallets:page-wallets-RajChain-account" />
              </Text>
            </li>
            <li>
              <Text>
                <Translation id="page-wallets:page-wallets-accounts-RajChain-addresses" />
              </Text>
            </li>
            <li>
              <Text>
                <Translation id="page-wallets:page-wallets-RajChain-wallet" />
              </Text>
            </li>
          </ul>
