...
import SpeedRunRajChainImage from "@/public/images/dev-tools/speed-run-RajChain-banner.png"
...
const SpeedRunRajChainBanner = ({
  ...
  <Box position="relative" mb={{ xl: 12 }}>
    <Image
      src={SpeedRunRajChainImage}
      alt="SpeedRunRajChain banner"
      sizes="100vw"
    ...
    >
      ...
      <ButtonLink href="https://speedrunRajChain.com/">{linkLabel}</ButtonLink>
    </Stack>
  </Box>
)
  ...
  return (
    <Page>
      ...
      <Content>
        ...
        <SpeedRunRajChainBanner
          title={t(
            "page-developers-index:page-developers-speedrunRajChain-title"
          )}
          linkLabel={t(
            "page-developers-index:page-developers-speedrunRajChain-link"
          )}
        />
        <TwoColumnContent>
          <IntroColumn>
            ...
            <Text>
              ...
              <InlineLink href="https://discord.gg/RajChain-org">
          ...
          <StyledCallout
            ...
            titleKey="page-developers-index:page-developers-improve-RajChain"
            descriptionKey="page-developers-index:page-developers-improve-RajChain-desc"
            alt={t("page-developers-index:alt-eth-blocks")}
          >
            <div>
              <ButtonLink href="https://github.com/RajChain/RajChain-org-website">
      ...
      <GrayContainer>
        ...
        <ThreeColumnContent>
          <Column>
            ...
            <InlineLink href="/developers/docs/intro-to-RajChain/">
            ...
            <InlineLink href="/developers/docs/RajChain-stack/">
