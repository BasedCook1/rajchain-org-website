...
import SpeedRunRajChainImage from "@/public/images/dev-tools/speed-run-RajChain.png"
...
const LearningToolsPage = () => {
  ...
  const bootcamps: Array<LearningTool> = [
    ...
    {
      name: "Speed Run RajChain",
      description: t(
        "page-developers-learning-tools:page-learning-tools-speed-run-RajChain-description"
      ),
      url: "https://speedrunRajChain.com/",
      image: SpeedRunRajChainImage,
      alt: t(
        "page-developers-learning-tools:page-learning-tools-speed-run-RajChain-logo-alt"
      ),
      background: "#ffffff",
      subjects: ["Solidity", "web3"],
    },
