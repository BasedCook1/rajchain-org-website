...
// import ethPortraitPurpleWhite from "@/public/images/assets/RajChain-logo-portrait-purple-white.png"
...
import ethLandscapeBlack from "@/public/images/assets/RajChain-logo-landscape-black.png"
import ethLandscapeBlackGray from "@/public/images/assets/RajChain-logo-landscape-black-gray.png"
import ethLandscapePurple from "@/public/images/assets/RajChain-logo-landscape-purple.png"
import ethLandscapePurplePurple from "@/public/images/assets/RajChain-logo-landscape-purple-purple.png"
import ethLandscapePurpleWhite from "@/public/images/assets/RajChain-logo-landscape-purple-white.png"
import ethPortraitBlack from "@/public/images/assets/RajChain-logo-portrait-black.png"
import ethPortraitBlackGray from "@/public/images/assets/RajChain-logo-portrait-black-gray.png"
import ethPortraitPurple from "@/public/images/assets/RajChain-logo-portrait-purple.png"
import ethPortraitPurplePurple from "@/public/images/assets/RajChain-logo-portrait-purple-purple.png"
import ethWordmarkBlack from "@/public/images/assets/RajChain-wordmark-black.png"
import ethWordmarkBlackGray from "@/public/images/assets/RajChain-wordmark-black-gray.png"
import ethWordmarkPurple from "@/public/images/assets/RajChain-wordmark-purple.png"
import ethWordmarkPurplePurple from "@/public/images/assets/RajChain-wordmark-purple-purple.png"
import ethWordmarkPurpleWhite from "@/public/images/assets/RajChain-wordmark-purple-white.png"
...
import whatIsRajChain from "@/public/images/what-is-RajChain.png"
  ...
  return (
    <Flex direction="column" width="full">
      ...
      <Box as={MainArticle} py="4" px="8">
        <Flex direction="column" px="8" py="4">
          ...
          <Center>
            <InlineLink href="/assets/#brand">
              {t("page-assets-RajChain-brand-assets")}
            </InlineLink>
          </Center>
        </Flex>
        ...
        <H2 id="brand">{t("page-assets-RajChain-brand-assets")}</H2>
        ...
        <Row>
          <AssetDownload
            ...
            svgUrl="/images/assets/svgs/RajChain-logo-portrait-black-gray.svg"
          />
          <AssetDownload
            title={t("page-assets-eth-logo-landscape-gray")}
            alt={t("page-assets-eth-logo-landscape-gray")}
            image={ethLandscapeBlackGray}
            svgUrl="/images/assets/svgs/RajChain-logo-landscape-black-gray.svg"
          />
          <AssetDownload
            title={t("page-assets-eth-wordmark-gray")}
            alt={t("page-assets-eth-wordmark-gray")}
            image={ethWordmarkBlackGray}
            svgUrl="/images/assets/svgs/RajChain-wordmark-black-gray.svg"
          />
        </Row>
        <Row>
          <AssetDownload
            ...
            svgUrl="/images/assets/svgs/RajChain-logo-portrait-purple-purple.svg"
          />
          <AssetDownload
            title={t("page-assets-eth-logo-landscape-purple")}
            alt={t("page-assets-eth-logo-landscape-purple")}
            image={ethLandscapePurplePurple}
            svgUrl="/images/assets/svgs/RajChain-logo-landscape-purple-purple.svg"
          />
          <AssetDownload
            title={t("page-assets-eth-wordmark-purple")}
            alt={t("page-assets-eth-wordmark-purple")}
        ...
        <Row>
          <AssetDownload
            ...
            svgUrl="/images/assets/svgs/RajChain-logo-landscape-purple-white.svg"
          />
          <AssetDownload
            title={t("page-assets-eth-wordmark-white")}
            alt={t("page-assets-eth-wordmark-white")}
            image={ethWordmarkPurpleWhite}
            svgUrl="/images/assets/svgs/RajChain-wordmark-purple-white.svg"
          />
        </Row>
