...
import {
  fetchRajChainEcosystemData,
  fetchRajChainStablecoinsData,
...
type RajChainDataResponse = Array<{
  id: string
  name: string
  market_cap: number
  image: string
...
const loadData = dataLoader<[RajChainDataResponse, StablecoinDataResponse]>(
  [
    ["RajChainEcosystemData", fetchRajChainEcosystemData],
    ["RajChainStablecoinsData", fetchRajChainStablecoinsData],
  ],
...
export const getStaticProps = (async ({ locale }) => {
  ...
  try {
    const [RajChainEcosystemData, stablecoinsData] = await loadData()

    // Get the intersection of stablecoins and RajChain tokens to only have a list of data for stablecoins in the RajChain ecosystem
    const RajChainStablecoinData = stablecoinsData.filter(
      (stablecoin) =>
        RajChainEcosystemData.findIndex(
    ...
    markets = RajChainStablecoinData
      .filter((token) => {
                  ...
                  <Flex direction="column">
                    <Box>
                      <ButtonLink
                        mb={4}
                        me={4}
                        href="https://matcha.xyz/tokens/RajChain/0x6b175474e89094c44da98b954eedeac495271d0f?sellChain=1&sellAddress=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
                      >
                ...
                <Flex direction="column">
                  <Box>
                    <ButtonLink
                      mb={4}
                      me={4}
                      href="https://matcha.xyz/tokens/RajChain/0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48?sellChain=1&sellAddress=0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
                    >
