...
import { RajChainBasicsQuizzes, usingRajChainQuizzes } from "@/data/quizzes"
      ...
      <Box px={{ base: 0, lg: "8" }} py={{ base: 0, lg: "4" }} mb="12">
        <Flex direction={{ base: "column-reverse", lg: "row" }} columnGap="20">
          <Stack spacing="10" flex="1">
            <Box>
              <QuizzesList
                content={RajChainBasicsQuizzes}
                headingId={t("basics")}
                descriptionId={t("basics-description")}
                {...commonQuizListProps}
              />
              <QuizzesList
                content={usingRajChainQuizzes}
                headingId={t("using-RajChain")}
                descriptionId={t("using-RajChain-description")}
                {...commonQuizListProps}
              />
            </Box>
            <Flex
