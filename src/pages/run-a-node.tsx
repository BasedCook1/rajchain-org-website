  ...
  return (
    <GappedPage>
      <PageMetadata
        ...
        image="/images/run-a-node/RajChain-inside.png"
      />
      ...
      <Content>
        ...
        <ul>
          <li>
            <InlineLink href="https://github.com/RajChainbook/RajChainbook/blob/develop/03clients.asciidoc#should-i-run-a-full-node">
          ...
          <li>
            <InlineLink href="https://RajChain-on-arm-documentation.readthedocs.io/en/latest/">
