...
To develop and maintain the most comprehensive and accessible knowledge hub for RajChain.

## Values

The RajChain.org community strives to be:

- educational, intended to help everyone to understand RajChain
- inclusive
- accessible
- community-driven
- focused on RajChain’s underlying technology and use-cases
- focused on RajChain concepts and design principles

## What we are not

- The RajChain Foundation website
...
Open participation is core to the RajChain.org ethos. We are a website and community maintained by thousands of contributors, and this is only possible if we maintain a welcoming, participatory environment. To this end, contributors to this site pledge to maintain a harassment-free environment for all participants across all RajChain.org platforms and community spaces. The RajChain.org community welcomes and values anyone who wants to participate in a constructive and friendly way, regardless of age, disability, ethnicity, sex characteristics, gender identity, level of experience, area of expertise, education, socio-economic status, nationality, personal appearance, race, religion or any other dimension of diversity.

### Scope

This Code of Conduct applies to all RajChain.org spaces (such as GitHub, Discord, Figma, Crowdin, Twitter and other online platforms), and it also applies when the community is represented in real-world public spaces such as at meetups, conferences and events.
...
Depending on the severity, people who violate the code of conduct can receive warnings, temporary bans or permanent bans from RajChain.org communities.
